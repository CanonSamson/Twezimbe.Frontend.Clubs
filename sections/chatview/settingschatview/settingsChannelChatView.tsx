...
export const SettingsChannelChatView = ({ group, channel }: SettingsProps) => {
    ...
    return (
      <>
        <div className="p-4 flex flex-col gap-2">
          <div className=" w-full  text-start  bg-white rounded-[10px] p-3 ">
          ...
          <button
            ...
            className=" w-full text-start text-red-600 bg-white rounded-[10px] p-3 "
          >
            Delete Channel
          </button>
        </div>
...
export default SettingsChannelChatView;
