  ...
  return (
    <>
      <div className=" w-full  p-2">
        <div className="p-2 bg-white rounded-[5px]">
          <div className=" text-center mt-5 border-2">
            <h2 className="text-xl font-bold">Create Your Group</h2>

            <p className="text-[14px] text-divider-200 mb-6">
              Groups are how you build communities and achieve together
            </p>
          </div>
        ...
        <div className="p-2 bg-white rounded-[5px]">
          <div className="text-center mt-5">
            ...
            <p className="text-[14px] text-divider-200 mb-6">
              Please provide more information to enable us to set up properly
            </p>
          </div>
            ...
            <div>
              ...
              <div className="mt-3  flex flex-wrap gap-2">
                {tags.map((tag) => (
                  <button
                    key={tag}
                    className="inline-flex items-center px-3 py-1 bg-divider-100 text-divider-300  text-sm rounded-[5px]"
                  >
                    {tag}
                    <button
        ...
        <div className="flex bg-primary justify-between bottom-0 rounded-[5px] p-2">
          <button
            className="px-4 py-2  invisible text-gray-200 rounded-md"
            onClick={() => back()}
          >
            Back
          </button>
