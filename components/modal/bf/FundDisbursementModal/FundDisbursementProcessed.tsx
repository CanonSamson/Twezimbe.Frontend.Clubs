...
const FundDisbursementProcessed = () => {
  const { toggleModal } = useSettingModal();

  const handleToggleModal = () => {
    toggleModal("fundDisbursementProcessedModal");
  };
      ...
      <div className="pb-12 pt-14 px-9">
        ...
        <div className="mt-9">
          <p className="w-full text-center font-bold text-[20px] leading-[150%] tracking-[0.03px]">
            Fund disbursement is being processed
          </p>
          <p className="mt-2 w-full text-center text-[14px] leading-[150%] tracking-[0%] ">
            ...
            and the recipient will be notified once this is complete.{" "}
          </p>
        </div>
...
export default FundDisbursementProcessed;
