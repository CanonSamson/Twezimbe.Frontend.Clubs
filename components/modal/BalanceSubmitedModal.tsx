...
const BalanceSubmittedModal = () => {
  ...
  const handleClose = () => {
    toggleModal("balanceSubmittedModal");
    router.push(`/bf/settings/${groupId}/${bfId}/transition-wallet`);
  };
  return (
    <div
      className={`${
        modals.balanceSubmittedModal ? "flex" : "hidden"
      ...
      <div className="bg-white w-full max-w-[450px]  rounded-tl-[10px] rounded-tr-[10px] rounded-br-[10px] p-6  relative">
        ...
        <div className="flex flex-col items-center mt-8">
          ...
          <p className="text-center mb-4 text-[12px]">
            The opening balance has been sent to James Mark for approval and you
            will be notified once it has been accepted or denied.
          </p>
...
export default BalanceSubmittedModal;
